...
void ui_flash_face_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_bg_color(page, lv_color_hex(COLOUR_BLACK), 0);
    ...
    // lv_obj_align(img_eye_left, LV_ALIGN_CENTER, -50, -15);
    lv_obj_align(img_eye_left, LV_ALIGN_CENTER, -50, -15);
    ...
    if (is_time_out(&time_50ms)) {
        ...
        case 0:
            if (0 == flash_sub_step) {
                ...
                lv_obj_align(img_eye_left, LV_ALIGN_CENTER, -20, -5);
                lv_obj_align(img_eye_right, LV_ALIGN_CENTER, 15, -5);
