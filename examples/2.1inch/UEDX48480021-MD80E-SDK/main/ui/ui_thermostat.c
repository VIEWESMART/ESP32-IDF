 ...
 */
void lv_create_obj_temp_roller(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_line_space(temp_wheel, 60, LV_PART_MAIN);
    lv_obj_set_style_bg_opa(temp_wheel, LV_OPA_TRANSP, LV_PART_SELECTED);
    lv_obj_set_style_text_font(temp_wheel, &HelveticaNeue_Regular_80, LV_PART_SELECTED);
    lv_obj_set_style_text_font(temp_wheel, &HelveticaNeue_Regular_48, LV_PART_MAIN);
...
void ui_thermostat_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_border_color(page, lv_color_make(230, 103, 80), 0);
    ...
    lv_obj_set_size(temp_arc, LV_HOR_RES - 100, LV_VER_RES - 100);
    ...
    lv_obj_set_style_pad_left(temp_arc, 10, LV_PART_KNOB);
    lv_obj_set_style_pad_right(temp_arc, 10, LV_PART_KNOB);
    lv_obj_set_style_pad_top(temp_arc, 10, LV_PART_KNOB);
    lv_obj_set_style_pad_bottom(temp_arc, 10, LV_PART_KNOB);
    ...
    lv_obj_set_style_bg_color(temp_arc, lv_color_make(0xFF, 0xFF, 0xFF), LV_PART_KNOB);

    lv_obj_align(temp_arc, LV_ALIGN_TOP_MID, 0, 30);

    lv_obj_t *img_temp_unit = lv_img_create(page);
    lv_img_set_src(img_temp_unit, &AC_unit);
    lv_obj_align(img_temp_unit, LV_ALIGN_CENTER, 70, -10);

    lv_create_obj_temp_roller(parent);
