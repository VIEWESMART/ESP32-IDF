...
void lv_create_factory_title(lv_obj_t *parent, const char *title_name, factory_step_t page)
{
    ...
    lv_obj_set_style_text_font(label_title, &SourceHanSansCN_Normal30, 0);
...
void lv_create_rst_select(lv_obj_t *parent)
{
    ...
    if ((NULL == imgbtn_TEST_OK) && (NULL == imgbtn_TEST_FAILED)) {
        ...
        lv_obj_set_style_text_font(label_EN, &SourceHanSansCN_Normal30, 0);
        ...
        lv_obj_set_style_text_font(label_CN, &SourceHanSansCN_Normal30, 0);
...
static void lv_create_test_encode(lv_obj_t *factory_bg, uint8_t event)
{
    ...
    if (NULL == label_guide) {
        ...
        lv_obj_set_style_text_font(label_guide, &SourceHanSansCN_Normal30, 0);
        ...
        lv_obj_set_style_text_font(label_version, &SourceHanSansCN_Normal30, 0);
