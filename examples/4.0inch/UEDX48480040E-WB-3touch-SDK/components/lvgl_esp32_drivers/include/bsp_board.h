...
#define LCD_4r0_480x480   1   // 4 inch   480-480
#define LCD_yysj_5_800x480   0   // 4 inch   480-480
 ...
 */
#define SDMMC_BUS_WIDTH (1)
#define GPIO_SDMMC_CLK  (GPIO_NUM_45)  //36
#define GPIO_SDMMC_CMD  (GPIO_NUM_42)  //37
#define GPIO_SDMMC_D0   (GPIO_NUM_46)  //35
#define GPIO_SDMMC_D1   (GPIO_NUM_NC)
#define GPIO_SDMMC_D2   (GPIO_NUM_NC)
#define GPIO_SDMMC_D3   (GPIO_NUM_NC)
#define GPIO_SDMMC_DET  (GPIO_NUM_NC)

#elif(LCD_yysj_5_800x480 ==1) 
